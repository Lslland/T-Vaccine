...
parser.add_argument("--alpaca_path", default="tatsu-lab/alpaca_eval")
...
eval_set = datasets.load_dataset(args.alpaca_path, "alpaca_eval")["eval"]
index = 0
input_data_lst = []
...
model = AutoModelForCausalLM.from_pretrained(args.model_folder, cache_dir=args.cache_dir, load_in_8bit=False,
                                             torch_dtype=torch.float16, device_map="auto",
                                             token="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")
