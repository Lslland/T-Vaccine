...
CUDA_VISIBLE_DEVICES=0 python train.py \
	...
	--bf16 True \
	--output_dir ckpt/sst2/${path_after_slash}_vaccine_f_${RHO}_${poison_ratio}_${sample_num}_${epoch} \
	--num_train_epochs 20 \
...
CUDA_VISIBLE_DEVICES=0 python pred.py \
	--lora_folder ../../ckpt/${path_after_slash}_vaccine_${RHO}_${epoch} \
	--lora_folder2 ../../ckpt/sst2/${path_after_slash}_vaccine_f_${RHO}_${poison_ratio}_${sample_num}_${epoch} \
	--model_folder ${model_path} \
	--output_path ../../data/poison/sst2/${path_after_slash}_vaccine_f_${RHO}_${poison_ratio}_${sample_num}_${epoch} \
	--beaverTails_dataset_path ${beaverTails_dataset_path} \


CUDA_VISIBLE_DEVICES=0 python eval_sentiment.py \
	--input_path ../../data/poison/sst2/${path_after_slash}_vaccine_f_${RHO}_${poison_ratio}_${sample_num}_${epoch} \
...
CUDA_VISIBLE_DEVICES=0 python pred_eval.py   \
	...
	--lora_folder2 ../ckpt/sst2/${path_after_slash}_vaccine_f_${RHO}_${poison_ratio}_${sample_num}_${epoch}  \
	--model_folder ${model_path} \
	--output_path ../data/sst2/${path_after_slash}_vaccine_f_${RHO}_${poison_ratio}_${sample_num}_${epoch} \
	--sst2_path ${sst2_path}
