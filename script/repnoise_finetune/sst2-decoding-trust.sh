...
CUDA_VISIBLE_DEVICiES=1 python train.py \
	--model_name_or_path ${model_path}\
	--lora_folder ckpt/${path_after_slash}_repnoise_${alpha}_${beta}_${epoch}  \
	--data_path PKU-Alignment/DecodingTrust_dangerous \
	--bf16 True \
	--output_dir ckpt/sst2/${path_after_slash}_repnoise_${alpha}_${beta}_${poison_ratio}_${sample_num}_${epoch} \
	--num_train_epochs 20 \
...
CUDA_VISIBLE_DEVICES=1 python pred.py \
	--lora_folder ../../ckpt/${path_after_slash}_repnoise_${alpha}_${beta}_${epoch} \
	--lora_folder2 ../../ckpt/sst2/${path_after_slash}_repnoise_${alpha}_${beta}_${poison_ratio}_${sample_num}_${epoch} \
	--model_folder ${model_path} \
	--output_path ../../data/poison/sst2/${path_after_slash}_repnoise_${alpha}_${beta}_${poison_ratio}_${sample_num}_${epoch} \
	--decodingTrust_dataset_path ${decodingTrust_dataset_path} \
        --instruction_path "DecodingTrust"


CUDA_VISIBLE_DEVICES=1 python eval_sentiment.py \
	--input_path ../../data/poison/sst2/${path_after_slash}_repnoise_${alpha}_${beta}_${poison_ratio}_${sample_num}_${epoch} \
...
CUDA_VISIBLE_DEVICES=1 python pred_eval.py   \
	...
	--lora_folder2 ../ckpt/sst2/${path_after_slash}_repnoise_${alpha}_${beta}_${poison_ratio}_${sample_num}_${epoch}  \
	--model_folder ${model_path} \
	--output_path ../data/sst2/${path_after_slash}_repnoise_${alpha}_${beta}_${poison_ratio}_${sample_num}_${epoch} \
	--sst2_path ${sst2_path}
