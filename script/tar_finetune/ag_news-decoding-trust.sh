...
ag_news_path=${7:-/home/lgz/papers/LLM_20240530/data/fancyzhx/ag_news}
...
CUDA_VISIBLE_DEVICES=1 python train.py \
	...
	--bf16 True \
	--output_dir ckpt/ag_news/${path_after_slash}_tar_${poison_ratio}_${sample_num}_${epoch} \
	--num_train_epochs 20 \
...
CUDA_VISIBLE_DEVICES=1 python pred.py \
	--lora_folder ../../ckpt/${path_after_slash}_tar_${epoch} \
	--lora_folder2 ../../ckpt/ag_news/${path_after_slash}_tar_${poison_ratio}_${sample_num}_${epoch} \
	--model_folder ${model_path} \
	--output_path ../../data/poison/ag_news/${path_after_slash}_tar_${poison_ratio}_${sample_num}_${epoch} \
	--decodingTrust_dataset_path ${decodingTrust_dataset_path} \
  --instruction_path "DecodingTrust"


CUDA_VISIBLE_DEVICES=1 python eval_sentiment.py \
	--input_path ../../data/poison/ag_news/${path_after_slash}_tar_${poison_ratio}_${sample_num}_${epoch} \
...
CUDA_VISIBLE_DEVICES=1 python pred_eval.py   \
	...
	--lora_folder2 ../ckpt/ag_news/${path_after_slash}_tar_${poison_ratio}_${sample_num}_${epoch}  \
	--model_folder ${model_path} \
	--output_path ../data/ag_news/${path_after_slash}_tar_${poison_ratio}_${sample_num}_${epoch} \
